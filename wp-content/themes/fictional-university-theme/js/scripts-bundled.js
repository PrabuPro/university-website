...
function () {
  ...
  function Search() {
    ...
    this.addSearchHTML();
    this.resultsDiv = (0, _jquery.default)("#search-overlay_results");
    ...
    value: function typingLogic() {
      if (this.searchField.val() != this.previousValue) {
        ...
        if (this.searchField.val()) {
          ...
          this.typingTimer = setTimeout(this.getResults.bind(this), 750); //here we are setting up setTimeout function in order to delay our search string. but it  will run for 
    ...
    value: function getResults() {
      ...
      */
      _jquery.default.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join(''), "\n                        ").concat(results.generalInfo.length ? '</ul>' : '', "\n                    </div>\n                    <div class=\"one-third\">\n                        <h2 class=\"search-overlay__section-title\" >Programs</h2>\n                        ").concat(results.programs.length ? '<ul class="link-list min-list ">' : "<p>No Programs matches that search. <a href=\"".concat(universityData.root_url, "/programs\">View all programs</a></p>"), "\n                            ").concat(results.programs.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n                        ").concat(results.programs.length ? '</ul>' : '', "\n                        <h2 class=\"search-overlay__section-title\" >Professors</h2>\n                        ").concat(results.professors.length ? '<ul class="professor-cards">' : "<p>No Professors matches that search.</p>", "\n                            ").concat(results.professors.map(function (item) {
...
function () {
  ...
  _createClass(MyNotes, [{
    ...
    value: function updateNote(e) {
      ...
      //assign data-id(post id)
      var thisNote = (0, _jquery.default)(e.target).parents("li"); //asign title and content to ourUpdatePost
    ...
    value: function createNote(e) {
      ...
      _jquery.default.ajax({
        ...
        data: ourNewPost,
        success: function success(response) {
          (0, _jquery.default)(".new-note-title, .new-note-body").val(); //below code will put the new post in to html page once create it
...
function () {
  ...
  _createClass(Like, [{
    ...
    value: function ourClickDispatcher(e) {
      //get the closet click for the like box. which means this listen to a click which cliked from anywhere in the
      //like box
